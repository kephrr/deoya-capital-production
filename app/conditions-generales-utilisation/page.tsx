  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-800">
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-16 py-14 space-y-12">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('object.title')}</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('siteAccess.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('siteContent.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('responsibility.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
          ...
          <ul className="space-y-2 text-sm text-stone-600 mt-3 ml-6">
            {t.raw('responsibility.items').map((item: string) => (
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('intellectualProperty.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
            {t('intellectualProperty.content1')}
          </p>
          <ul className="space-y-2 text-sm text-stone-600 mt-3 ml-6">
            {t.raw('intellectualProperty.items').map((item: string) => (
              <li key={item} className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-stone-400" />{item}
              </li>
            ))}
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('externalLinks.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('personalData.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold text-stone-900 mb-6 pb-3 border-b border-stone-200">{t('applicableLaw.title')}</h2>
          <p className="text-sm text-stone-600 leading-relaxed">
