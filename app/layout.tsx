...
export const metadata: Metadata = {
  ...
  description:
    'Cabinet de conseil spécialisé dans l\'accompagnement stratégique et opérationnel de projets d\'investissement transfrontaliers entre l\'Afrique et l\'Europe.',
  icons: {
    icon: [
