...
type ConditionsGeneralesUtilisationPageClientProps = {
  locale?: Locale
}

export default function ConditionsGeneralesUtilisationPageClient({ locale = "fr" }: ConditionsGeneralesUtilisationPageClientProps) {
