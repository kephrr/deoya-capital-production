...
type ReseauPageClientProps = {
  locale?: Locale
}

export default function ReseauPageClient({ locale = "fr" }: ReseauPageClientProps) {
  ...
  const expertisesSectorielles = {
    ...
    secteurs: t.raw('expertisesSectorielles.secteurs') as Array<{
      name: string;
      desc: string;
    }>
  }
